package com.example.uadnd.cou8901.bakersresourceapp.gson;

import com.example.uadnd.cou8901.bakersresourceapp.db.Recipe;
...
public class GsonParser {
    static String jsonString = "{\"recipes\" : [\n" +
            "\n" +
            "    {\n" +
            "        \"id\": 1,\n" +
            "        \"name\": \"Nutella Pie\",\n" +
            ...
            "            {\n" +
            "                \"id\": 0,\n" +
            "                \"shortDescription\": \"Recipes Introduction\",\n" +
    ...
    static String jsonString2 = "[\n" +
            ...
            "\n" +
            "]";
    public static Recipes parse1(String jsonString) {
        Recipes recipes;
        Gson gson = new Gson();
        recipes = gson.fromJson(jsonString, Recipes.class);
        return recipes;
    }
    public static Recipes parse2() {
        Recipes recipes;
        Gson gson = new Gson();
        recipes = gson.fromJson(jsonString, Recipes.class);
        return recipes;
    }
    public static Recipes parse(String arrayListJsonRecipes) {
        Recipes recipes = null;
        //ArrayList<Recipe> recipeArrayList;
        Recipe [] recipes1;
        Gson gson = new Gson();
        //Timber.d(arrayListJsonRecipes);
        //recipeArrayList = gson.fromJson(jsonString2, Recipes[].class);
        recipes1 = gson.fromJson(arrayListJsonRecipes, Recipe[].class);
        //System.out.println("Recipes Length2 : " + recipes1.length);
        recipes = new Recipes(new ArrayList<Recipe>(Arrays.asList(recipes1)));
        //Log using Timber
        return recipes;
    }
